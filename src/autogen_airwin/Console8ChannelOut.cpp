...
bool Console8ChannelOut::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Console8ChannelOut::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
