...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::Longhand {
...
bool Longhand::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Longhand::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
