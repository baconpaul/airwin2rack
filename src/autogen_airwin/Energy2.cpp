...
bool Energy2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Energy2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
