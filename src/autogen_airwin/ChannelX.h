...
#ifndef __ChannelX_ChannelX_H
#define __ChannelX_ChannelX_H
...
const unsigned long kUniqueId = 'chaX';    //Change this to what the AU identity is!

class ChannelX : 
    public AudioEffectX 
{
public:
    ChannelX(audioMasterCallback audioMaster);
    ~ChannelX();
