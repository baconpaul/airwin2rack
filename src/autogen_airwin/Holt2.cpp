...
bool Holt2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
    case kParamA: { auto b = string2float(text, value); return b; break; }
    case kParamB: { auto b = string2float(text, value); return b; break; }
    case kParamC: { auto b = string2float(text, value); if (b) { value = value / (8.0); } return b; break; }
...
bool Holt2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
