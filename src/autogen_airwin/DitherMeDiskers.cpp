...
bool DitherMeDiskers::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool DitherMeDiskers::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
