...
#ifndef __Weave_Weave_H
#define __Weave_Weave_H
...
const unsigned long kUniqueId = 'weav';    //Change this to what the AU identity is!

class Weave : 
    public AudioEffectX 
{
public:
    Weave(audioMasterCallback audioMaster);
    ~Weave();
