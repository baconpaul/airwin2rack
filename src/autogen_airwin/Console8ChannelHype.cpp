...
#endif
namespace airwin2rack::Console8ChannelHype {
...
bool Console8ChannelHype::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Console8ChannelHype::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
