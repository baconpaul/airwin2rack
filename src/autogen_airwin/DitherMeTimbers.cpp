...
bool DitherMeTimbers::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool DitherMeTimbers::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
