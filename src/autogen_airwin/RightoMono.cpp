...
#endif
namespace airwin2rack::RightoMono {
...
bool RightoMono::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool RightoMono::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
