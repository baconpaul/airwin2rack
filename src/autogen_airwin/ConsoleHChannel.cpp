...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleHChannel {
...
bool ConsoleHChannel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool ConsoleHChannel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
