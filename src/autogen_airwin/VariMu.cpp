...
bool VariMu::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool VariMu::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
