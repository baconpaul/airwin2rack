...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleX3Pre {
...
bool ConsoleX3Pre::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ConsoleX3Pre::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
