...
bool Crystal::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Crystal::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
