...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::Ultralight {
...
bool Ultralight::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
    case kParamA: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 9.99; } return b; break; }
    case kParamB: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 4.99; } return b; break; }
    case kParamC: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 4.99; } return b; break; }
    case kParamD: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 4.99; } return b; break; }
...
bool Ultralight::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
