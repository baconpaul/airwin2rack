...
#endif
namespace airwin2rack::PurestConsole3Channel {
...
bool PurestConsole3Channel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool PurestConsole3Channel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
