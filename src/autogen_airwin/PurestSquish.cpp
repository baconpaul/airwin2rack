...
#endif
namespace airwin2rack::PurestSquish {
...
bool PurestSquish::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool PurestSquish::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
