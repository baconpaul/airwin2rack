...
#endif
namespace airwin2rack::NonlinearSpace {
...
bool NonlinearSpace::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool NonlinearSpace::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
