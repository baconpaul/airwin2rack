...
#endif
namespace airwin2rack::MatrixVerb {
...
bool MatrixVerb::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool MatrixVerb::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
