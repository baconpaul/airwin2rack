...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::BezEQ {
...
bool BezEQ::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool BezEQ::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
