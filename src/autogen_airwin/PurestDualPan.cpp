...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::PurestDualPan {
...
bool PurestDualPan::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool PurestDualPan::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
