...
#endif
namespace airwin2rack::Monitoring {
...
bool Monitoring::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Monitoring::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
