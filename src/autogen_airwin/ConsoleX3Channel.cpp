...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleX3Channel {
...
bool ConsoleX3Channel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
    case kParamSMO: { auto b = string2float(text, value); return b; break; }
    case kParamTRM: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 4.0; } return b; break; }
...
bool ConsoleX3Channel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
