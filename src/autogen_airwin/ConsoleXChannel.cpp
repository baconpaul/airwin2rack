...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleXChannel {
...
bool ConsoleXChannel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ConsoleXChannel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
