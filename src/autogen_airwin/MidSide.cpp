...
bool MidSide::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool MidSide::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
