...
bool ConsoleMCChannel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ConsoleMCChannel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
