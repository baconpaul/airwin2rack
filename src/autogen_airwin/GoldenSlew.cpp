...
#endif
namespace airwin2rack::GoldenSlew {
...
bool GoldenSlew::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool GoldenSlew::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
