...
bool kPlateD::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kPlateD::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
