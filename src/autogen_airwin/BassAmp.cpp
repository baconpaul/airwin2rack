...
bool BassAmp::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool BassAmp::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
