...
bool NaturalizeDither::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool NaturalizeDither::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
