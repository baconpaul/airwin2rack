...
#include "Highpass2.h"
#endif
namespace airwin2rack::Highpass2 {
...
bool Highpass2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Highpass2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
