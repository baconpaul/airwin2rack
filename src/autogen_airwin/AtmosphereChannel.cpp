...
bool AtmosphereChannel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool AtmosphereChannel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
