...
#include "YHighpass.h"
#endif
namespace airwin2rack::YHighpass {
...
bool YHighpass::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool YHighpass::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
