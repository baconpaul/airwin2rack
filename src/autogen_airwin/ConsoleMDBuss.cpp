...
#endif
namespace airwin2rack::ConsoleMDBuss {
...
bool ConsoleMDBuss::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ConsoleMDBuss::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
