...
bool Console5Channel::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Console5Channel::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
