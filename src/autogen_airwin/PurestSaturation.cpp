...
bool PurestSaturation::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool PurestSaturation::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
