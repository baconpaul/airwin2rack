...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::kPlate140 {
...
bool kPlate140::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kPlate140::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
