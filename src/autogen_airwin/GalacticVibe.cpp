...
#endif
namespace airwin2rack::GalacticVibe {
...
bool GalacticVibe::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool GalacticVibe::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
