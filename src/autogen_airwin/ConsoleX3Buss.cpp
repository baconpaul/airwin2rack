...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleX3Buss {
...
bool ConsoleX3Buss::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ConsoleX3Buss::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
