...
#endif
namespace airwin2rack::Console8SubIn {
...
bool Console8SubIn::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Console8SubIn::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
