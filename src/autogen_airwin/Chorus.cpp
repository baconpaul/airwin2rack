...
bool Chorus::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Chorus::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
