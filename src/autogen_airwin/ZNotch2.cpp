...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ZNotch2 {
...
bool ZNotch2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool ZNotch2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
