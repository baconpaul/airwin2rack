...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::ConsoleHPre {
...
bool ConsoleHPre::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool ConsoleHPre::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
