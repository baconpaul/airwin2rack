...
bool Console8SubHype::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Console8SubHype::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
