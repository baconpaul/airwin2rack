...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::kPlate240 {
...
bool kPlate240::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kPlate240::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
