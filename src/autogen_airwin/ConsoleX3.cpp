...
AudioEffect* createEffectInstance(audioMasterCallback audioMaster) {return new ConsoleX3(audioMaster);}

ConsoleX3::ConsoleX3(audioMasterCallback audioMaster) :
...
ConsoleX3::~ConsoleX3() {}
VstInt32 ConsoleX3::getVendorVersion () {return 1000;}
void ConsoleX3::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void ConsoleX3::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
void ConsoleX3::setParameter(VstInt32 index, float value) {
    switch (index) {
		...
		case kParamMDE: MDE = value; break;
...
float ConsoleX3::getParameter(VstInt32 index) {
    switch (index) {
        ...
        case kParamMDE: return MDE; break;
...
void ConsoleX3::getParameterName(VstInt32 index, char *text) {
    switch (index) {
        ...
        case kParamMDE: vst_strncpy (text, "Cha/Bus", kVstMaxParamStrLen); break;
...
void ConsoleX3::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
        ...
        case kParamTRM: float2string (TRM, text, kVstMaxParamStrLen); break;
        case kParamMDE: float2string (MDE, text, kVstMaxParamStrLen); break;
...
void ConsoleX3::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
        ...
        case kParamTHR: vst_strncpy (text, "comp", kVstMaxParamStrLen); break;
        ...
        case kParamMDE: vst_strncpy (text, "mode", kVstMaxParamStrLen); break;
...
VstInt32 ConsoleX3::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool ConsoleX3::getEffectName(char* name) {
    vst_strncpy(name, "ConsoleX3", kVstMaxProductStrLen); return true;
}

VstPlugCategory ConsoleX3::getPlugCategory() {return kPlugCategEffect;}

bool ConsoleX3::getProductString(char* text) {
  	vst_strncpy (text, "airwindows ConsoleX3", kVstMaxProductStrLen); return true;
}

bool ConsoleX3::getVendorString(char* text) {
  	vst_strncpy (text, "airwindows", kVstMaxVendorStrLen); return true;
}
bool ConsoleX3::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
    ...
    case kParamATK: { auto b = string2float(text, value); return b; break; }
    case kParamRLS: { auto b = string2float(text, value); return b; break; }
    case kParamRAT: { auto b = string2float(text, value); return b; break; }
    case kParamTRM: { auto b = string2float(text, value); return b; break; }
    case kParamMDE: { auto b = string2float(text, value); return b; break; }
    case kParamSMO: { auto b = string2float(text, value); return b; break; }
    case kParamMOR: { auto b = string2float(text, value); return b; break; }
    case kParamLOP: { auto b = string2float(text, value); return b; break; }
    case kParamLPQ: { auto b = string2float(text, value); return b; break; }
    case kParamHIP: { auto b = string2float(text, value); return b; break; }
    case kParamHPQ: { auto b = string2float(text, value); return b; break; }
...
bool ConsoleX3::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
        ...
        case kParamATK: return true;
        case kParamRLS: return true;
        case kParamRAT: return true;
        case kParamTRM: return true;
        case kParamMDE: return true;
        case kParamSMO: return true;
        case kParamMOR: return true;
        case kParamLOP: return true;
        case kParamLPQ: return true;
        case kParamHIP: return true;
        case kParamHPQ: return true;
