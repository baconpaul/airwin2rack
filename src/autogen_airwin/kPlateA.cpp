...
bool kPlateA::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kPlateA::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
