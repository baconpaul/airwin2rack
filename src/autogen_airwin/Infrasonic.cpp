...
#endif
namespace airwin2rack::Infrasonic {
...
bool Infrasonic::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Infrasonic::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
