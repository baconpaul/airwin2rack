...
#include "PowerSag2.h"
#endif
namespace airwin2rack::PowerSag2 {
...
bool PowerSag2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool PowerSag2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
