...
bool HighGlossDither::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool HighGlossDither::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
