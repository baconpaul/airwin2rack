...
bool Holt::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool Holt::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
