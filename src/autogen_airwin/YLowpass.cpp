...
#include "YLowpass.h"
#endif
namespace airwin2rack::YLowpass {
...
bool YLowpass::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool YLowpass::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
