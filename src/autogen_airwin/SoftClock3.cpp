...
bool SoftClock3::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
    ...
    case kParamD: { auto b = string2float(text, value); if (b) { value = (value + 0.1) / 1.99; } return b; break; }
    case kParamE: { auto b = string2float(text, value); return b; break; }

    }
    return false;
}
bool SoftClock3::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
