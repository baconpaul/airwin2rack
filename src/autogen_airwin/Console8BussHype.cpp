...
#endif
namespace airwin2rack::Console8BussHype {
...
bool Console8BussHype::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool Console8BussHype::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
