...
#endif
namespace airwin2rack::PurestConsole3Buss {
...
bool PurestConsole3Buss::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool PurestConsole3Buss::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
