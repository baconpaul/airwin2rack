...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::DeBez {
...
bool DeBez::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool DeBez::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
