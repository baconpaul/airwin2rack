...
#include "StarChild.h"
#endif
namespace airwin2rack::StarChild {
...
bool StarChild::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool StarChild::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
