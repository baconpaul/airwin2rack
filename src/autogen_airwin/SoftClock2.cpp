...
#include <cstdlib>
#include <algorithm>
namespace airwinconsolidated::SoftClock2 {
...
bool SoftClock2::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool SoftClock2::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
