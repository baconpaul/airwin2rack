...
#endif
namespace airwin2rack::kCathedral {
...
bool kCathedral::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {
...
bool kCathedral::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
