...
#include "UltrasonX.h"
#endif
namespace airwin2rack::UltrasonX {
...
bool UltrasonX::parameterTextToValue(VstInt32 index, const char *text, float &value) {
    switch(index) {

    }
    return false;
}
bool UltrasonX::canConvertParameterTextToValue(VstInt32 index) {
    switch(index) {
